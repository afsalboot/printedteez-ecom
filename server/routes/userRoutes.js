...
router.get("/addresses", protected, getSavedAddresses);
router.post("/addresses", protected, addSavedAddress);
router.put("/addresses/:addressId", protected, updateSavedAddress);
router.delete("/addresses/:addressId", protected, deleteSavedAddress);

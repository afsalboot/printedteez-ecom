        ...
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-black/10 bg-white text-gray-700 shadow-sm transition hover:border-black hover:text-black dark:border-slate-700 dark:bg-slate-900 dark:text-gray-200 dark:hover:border-slate-500"
              aria-label="Go back"
            >

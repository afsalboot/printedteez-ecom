...
const LiveOffers = () => {
  ...
  if (loading) {
    return (
      <div className="border-b border-black/5 bg-[#f3ebe2] px-4 py-2 text-center text-[11px] font-medium uppercase tracking-[0.2em] text-[#7b2b21]">
        Checking offers...
      </div>
    );
  }
  ...
  return (
    <>
      ...
      `}</style>
      <div className="border-b border-black/5 bg-[#f3ebe2] text-[#201715]">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-2 sm:px-6 lg:px-8">
          <div className="inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-[#7b2b21]">
            <Ticket className="h-3.5 w-3.5 animate-pulse" />
          Live Offer
          </div>

          <div className="min-w-0 flex-1 overflow-hidden text-sm font-medium text-[#2c211e]">
            <div
            ...
            >
              {[0, 1].map((copy) => (
                ...
                >
                  ...
                  <span className="inline-flex items-center gap-2 whitespace-nowrap text-[#6d605c]">
          ...
          <div className="hidden items-center gap-2 text-[11px] font-medium uppercase tracking-[0.2em] text-[#6d605c] md:inline-flex">

...
export const listCoupons = () => async (dispatch) => {
  try {
    dispatch(couponStart());
    const { data } = await api.get("/coupon/admin/list-coupon");
...
export const createCoupon = (payload) => async (dispatch) => {
  try {
    dispatch(couponStart());
    const { data } = await api.post("/coupon/admin/create-coupon", payload);
...
export const updateCoupon = (id, payload) => async (dispatch) => {
  try {
    dispatch(couponStart());
    const { data } = await api.put(`/coupon/admin/update-coupon/${id}`, payload);
...
export const deleteCoupon = (id) => async (dispatch) => {
  try {
    dispatch(couponStart());
    const { data } = await api.delete(`/coupon/admin/delete-coupon/${id}`);
...
export const toggleCouponStatus = (id) => async (dispatch) => {
  try {
    dispatch(couponStart());
    const { data } = await api.patch(`/coupon/admin/toggle-coupon/${id}`);
